...
Examine the user input to identify all key topics and entities, then use the `fetch_knowledge_subgraph` tool to retrieve relevant portions of the knowledge graph.
"""
